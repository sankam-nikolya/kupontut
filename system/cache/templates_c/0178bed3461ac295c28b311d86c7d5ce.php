...
<div class="c_c">
	<div class="c_content">
		...
		<div class="crumb"><span><?php  echo $page['title'];  ?></span></div>
		<?php  echo $page['prev_text'];  ?>
		<div class="clear"><img src="<?php if(isset($THEME)){ echo $THEME; } ?>/images/x.gif" alt="" /></div>
	</div>
</div>
<div class="c_b">
	<a href="/shop/category/minsk/current_stock" class="button4"><span class="l">&nbsp;</span><span class="c">Просмотреть текущие акции</span><span class="r">&nbsp;</span></a>
</div>
<div class="clear"><img src="<?php if(isset($THEME)){ echo $THEME; } ?>/images/x.gif" alt="" /></div>
<div class="know"><p>Узнайте, как KuponTut.by может помочь Вам получить тысячи новых покупателей </p></div>
<div class="clear"><img src="<?php if(isset($THEME)){ echo $THEME; } ?>/images/x.gif" height="70" alt="" /></div><?php $mabilis_ttl=1311509913; $mabilis_last_modified=1311420763; //Z:\home\kupontut.il\www\/templates/kupon/page_full.tpl ?>