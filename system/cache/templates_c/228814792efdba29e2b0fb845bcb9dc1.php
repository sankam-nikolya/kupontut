<form method="post" action="<?php if(isset($BASE_URL)){ echo $BASE_URL; } ?>admin/pages/update/<?php if(isset($update_page_id)){ echo $update_page_id; } ?>" id="edit_page_form<?php if(isset($update_page_id)){ echo $update_page_id; } ?>" style="width:100%;">
...
<div class="footer_block" align="right">
    <input type="submit" name="button" id="page_save_button" class="button_silver_130" value="Сохранить" onclick="ajax_me('edit_page_form<?php if(isset($update_page_id)){ echo $update_page_id; } ?>');" />
...
<?php $mabilis_ttl=1311507099; $mabilis_last_modified=1303831608; //Z:\home\kupontut.il\www\/templates/administrator/edit_page.tpl ?>